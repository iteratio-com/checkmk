...
import DemoCmkChipDev from './DemoCmkChipDev.vue'
...
<template>
  <DemoDetailPageLayout>
    <DemoDetailPageHeader>CmkChip</DemoDetailPageHeader>
    ...
    <DemoDetailPageCodeExample :code="codeExampleCmkChip" />

    <DemoDetailPageAccessibility :data="a11yDataCmkChip" />

    <DemoDetailPageDeveloperPlayground>
      <DemoCmkChipDev :screenshot-mode="screenshotMode" />
    </DemoDetailPageDeveloperPlayground>
  </DemoDetailPageLayout>
</template>
