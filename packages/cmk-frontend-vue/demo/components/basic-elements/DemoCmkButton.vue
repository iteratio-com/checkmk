...
import DemoCmkButtonDev from './DemoCmkButtonDev.vue'
...
<template>
  <DemoDetailPageLayout>
    <DemoDetailPageHeader>CmkButton</DemoDetailPageHeader>
    ...
    <DemoDetailPageCodeExample :code="codeExampleCmkButton" />

    <DemoDetailPageAccessibility :data="a11yDataCmkButton" />

    <DemoDetailPageDeveloperPlayground>
      <DemoCmkButtonDev :screenshot-mode="screenshotMode" />
    </DemoDetailPageDeveloperPlayground>
  </DemoDetailPageLayout>
</template>
