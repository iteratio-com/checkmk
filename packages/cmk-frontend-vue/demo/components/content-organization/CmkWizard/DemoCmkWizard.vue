...
<template>
  <DemoDetailPageLayout>
    <DemoDetailPageHeader>CmkWizard</DemoDetailPageHeader>
    ...
    <DemoDetailPageCodeExample :code="codeExampleCmkWizard" />

    <DemoDetailPageAccessibility :data="a11yDataCmkWizard" />
  </DemoDetailPageLayout>
</template>
