...
import DemoCmkSlideInDev from './DemoCmkSlideInDev.vue'
...
<template>
  <DemoDetailPageLayout>
    <DemoDetailPageHeader>CmkSlideIn</DemoDetailPageHeader>
    ...
    <DemoDetailPageCodeExample :code="codeExampleCmkSlideIn" />

    <DemoDetailPageAccessibility :data="a11yDataCmkSlideIn" />

    <DemoDetailPageDeveloperPlayground>
      <DemoCmkSlideInDev :screenshot-mode="screenshotMode" />
    </DemoDetailPageDeveloperPlayground>
  </DemoDetailPageLayout>
</template>
