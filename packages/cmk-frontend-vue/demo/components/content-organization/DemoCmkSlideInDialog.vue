...
import DemoCmkSlideInDialogDev from './DemoCmkSlideInDialogDev.vue'
...
<template>
  <DemoDetailPageLayout>
    <DemoDetailPageHeader>CmkSlideInDialog</DemoDetailPageHeader>
    ...
    <DemoDetailPageCodeExample :code="codeExampleCmkSlideInDialog" />

    <DemoDetailPageAccessibility :data="a11yDataCmkSlideInDialog" />

    <DemoDetailPageDeveloperPlayground>
      <DemoCmkSlideInDialogDev :screenshot-mode="screenshotMode" />
    </DemoDetailPageDeveloperPlayground>
  </DemoDetailPageLayout>
</template>
