...
def test_agent_aws_elasticache_summary(
    ...
    assert elasticache_summary._received_results  # noqa: SLF001
...
def test_agent_aws_elasticache_summary_witout_colleague_content(
    ...
    assert not elasticache_summary._received_results  # noqa: SLF001
...
def test_agent_aws_elasticache(
    ...
    assert elasticache._received_results  # noqa: SLF001
