...
CMK_UTILS_DEPENDENCIES = {
    Component("cmk.utils.agent_registration"): _allow("cmk.ccc.hostaddress"),
    Component("cmk.utils.auto_queue"): _allow("cmk.ccc.hostaddress"),
    Component("cmk.utils.automation_config"): _allow("cmk.ccc.site"),
    ...
    Component("cmk.utils.caching"): _allow(),
    Component("cmk.utils.caching_redis"): _allow("cmk.utils.caching", "cmk.utils.redis"),
    Component("cmk.utils.certs"): _allow(
        "cmk.utils.log",
        "cmk.ccc.site",
        "cmk.ccc.user",
        "cmk.crypto",
        "cmk.utils.security_event",
    ),
    Component("cmk.utils.check_utils"): _allow(),
    Component("cmk.utils.config_warnings"): _allow("cmk.utils.log", "cmk.ccc.tty"),
    Component("cmk.utils.crypto"): _allow(),
    Component("cmk.utils.datastructures"): _allow(),
    Component("cmk.utils.dateutils"): _allow("cmk.ccc.i18n"),
    Component("cmk.utils.deprecation_warnings"): _allow(),
    Component("cmk.utils.encoding"): _allow(),
    Component("cmk.utils.encryption"): _allow("cmk.ccc.exceptions", "cmk.crypto"),
    Component("cmk.utils.escaping"): _allow("cmk.utils.urls"),
    Component("cmk.utils.everythingtype"): _allow(),
    Component("cmk.utils.experimental_config"): _allow(),
    Component("cmk.utils.global_ident_type"): _allow(),
    ...
    Component("cmk.utils.html"): _allow(),
    Component("cmk.utils.http_proxy_config"): _allow("cmk.utils.password_store"),
    Component("cmk.utils.images"): _allow(),
    Component("cmk.utils.ip_lookup"): _allow(
        "cmk.utils.caching",
        "cmk.utils.log",
        "cmk.utils.paths",
        "cmk.ccc.debug",
    ...
    Component("cmk.utils.licensing"): _allow(
        "cmk.utils.automation_config",
        "cmk.utils.paths",
        "cmk.ccc.plugin_registry",
        "cmk.ccc.site",
        "cmk.ccc.store",
        "cmk.ccc.version",
        "cmk.livestatus_client",
    ),
    Component("cmk.utils.local_secrets"): _allow(
        "cmk.utils.paths",
        "cmk.ccc.store",
        "cmk.ccc.user",
        "cmk.crypto",
    ),
    Component("cmk.utils.log"): _allow("cmk.utils.jsontype", "cmk.utils.paths", "cmk.ccc.tty"),
    Component("cmk.utils.macros"): _allow(),
    Component("cmk.utils.mail"): _allow("cmk.utils.paths", "cmk.ccc.store", "cmk.ccc.version"),
    Component("cmk.utils.man_pages"): _allow(
        "cmk.ccc.debug",
        "cmk.ccc.exceptions",
        "cmk.ccc.i18n",
        "cmk.ccc.tty",
    ),
    Component("cmk.utils.metrics"): _allow(),
    Component("cmk.utils.misc"): _allow(),
    Component("cmk.utils.mrpe_config"): _allow(),
    Component("cmk.utils.ms_teams_constants"): _allow(),
    Component("cmk.utils.msi_engine"): _allow(
        "cmk.utils.msi_patch",
        "cmk.ccc.version",
    ),
    ...
    Component("cmk.utils.paths"): _allow(),
    Component("cmk.utils.plugin_loader"): _allow(),
    ...
    Component("cmk.utils.redis"): _allow("cmk.utils.paths", "cmk.ccc.exceptions"),
    Component("cmk.utils.render"): _allow("cmk.ccc.i18n"),
    ...
    Component("cmk.utils.schedule"): _allow(),
    Component("cmk.utils.sectionname"): _allow(),
    Component("cmk.utils.security_event"): _allow(
        "cmk.utils.jsontype",
        "cmk.utils.paths",
    ),
    Component("cmk.utils.semantic_version"): _allow(),
    Component("cmk.utils.servicename"): _allow(),
    Component("cmk.utils.setup_search_index"): _allow("cmk.utils.paths", "cmk.ccc.store"),
    Component("cmk.utils.statename"): _allow("cmk.ccc.i18n"),
    Component("cmk.utils.tags"): _allow(
        "cmk.ccc.exceptions",
        "cmk.ccc.hostaddress",
        "cmk.ccc.i18n",
        "cmk.ccc.site",
    ),
    Component("cmk.utils.timeout"): _allow(),
    Component("cmk.utils.timeperiod"): _allow("cmk.utils.dateutils", "cmk.ccc.i18n"),
    Component("cmk.utils.typing_helpers"): _allow(),
    Component("cmk.utils.unixsocket_http"): _allow(),
    Component("cmk.utils.urls"): _allow("cmk.ccc.regex"),
    Component("cmk.utils.visuals"): _allow("cmk.utils.paths"),
...
COMPONENTS: Mapping[Component, ImportCheckerProtocol] = {
    ...
    **{
    ...
    Component("cmk.liveproxyd.shared"): _allow(),
    Component("cmk.liveproxyd.daemon"): _allow(
        *PACKAGE_CCC,
        *PACKAGE_TRACE,
        "cmk.inventory",
        "cmk.liveproxyd.shared",
        "cmk.utils",
    ),
    Component("cmk.liveproxyd.gui"): _allow(
        *PACKAGE_CCC,
        "cmk.gui",
        "cmk.liveproxyd.shared",
        "cmk.utils",
